...
import red4.bubbles.entity.ModEntities;
...
public class Bubbles {
    ...
    public static final RegistryObject<Block> BELLOW = BLOCKS.register("bellow", () -> new BellowsBlock(AbstractBlock.Properties.create(Material.IRON)));
