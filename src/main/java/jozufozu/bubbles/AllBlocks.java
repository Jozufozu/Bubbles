...
public class AllBlocks {
    ...
    public static final RegistryObject<Item> BELLOW_ITEM = AllItems.ITEMS.register("bellow", () -> new BlockItem(BELLOW.get(), new Item.Properties().tab(ItemGroup.TAB_MISC)));
    public static final RegistryObject<Block> SOAP_BLOCK = BLOCKS.register("soap_block", SoapBlock::new);
    public static final RegistryObject<Item> SOAP_BLOCK_ITEM = AllItems.ITEMS.register("soap_block", () -> new BlockItem(SOAP_BLOCK.get(), new Item.Properties().tab(ItemGroup.TAB_MISC)));
    ...
    public static final RegistryObject<Item> BUBBLE_PLATE_ITEM = AllItems.ITEMS.register("bubble_plate", () -> new BlockItem(BUBBLE_PLATE.get(), new Item.Properties().tab(ItemGroup.TAB_MISC)));
}
